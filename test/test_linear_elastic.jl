...
@testset "LinearElastic" begin
    ...
    tangent = MaterialModels.native_tangent(LinearElastic)
    @test MaterialModels.straintrait(typeof(tangent)) == MaterialModels._SmallStrain()
    @test MaterialModels.stresstrait(typeof(tangent)) == MaterialModels._TrueStress()
end
